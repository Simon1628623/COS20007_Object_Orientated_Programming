...
${OBJECTDIR}/Sonar.o: Sonar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sonar.o Sonar.cpp
...
${TESTDIR}/TestRover.o: TestRover.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestRover.o TestRover.cpp


${TESTDIR}/test_rover.o: test_rover.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_rover.o test_rover.cpp


${TESTDIR}/BatteryTest.o: BatteryTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/BatteryTest.o BatteryTest.cpp


${TESTDIR}/battery_test.o: battery_test.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/battery_test.o battery_test.cpp


${TESTDIR}/DevicesTest.o: DevicesTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/DevicesTest.o DevicesTest.cpp


${TESTDIR}/devices_test.o: devices_test.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/devices_test.o devices_test.cpp
...
${OBJECTDIR}/Object_nomain.o: ${OBJECTDIR}/Object.o Object.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Object_nomain.o Object.cpp;\
	else  \
...
${OBJECTDIR}/Sonar_nomain.o: ${OBJECTDIR}/Sonar.o Sonar.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sonar_nomain.o Sonar.cpp;\
	else  \
